...
class TestTextNode(unittest.TestCase):
    ...
    def test_link_valid(self):
        ...
        self.assertEqual(html_node.props, {'href': 'www.google.co.uk'})
    ...
    def test_image_valid(self):
        node = TextNode("This is an image node", TextType.IMAGE, url="www.example.com")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "img")
        self.assertEqual(html_node.value, "")
        self.assertEqual(html_node.props, {'src': 'www.example.com', 'alt': 'This is an image node'})
    ...
    def test_image_none(self):
        ...
        self.assertEqual(html_node.tag, "img")
        self.assertEqual(html_node.value, "")
        self.assertEqual(html_node.props, {'src': None, 'alt': 'This is an image node'})
